  ...
  return (
    <main className="site-shell">
      ...
      <section id="about" className="section about-section container">
        ...
        <div className="about-grid"><div className="about-photo image-card"><img src="/warrior-core.png" alt="Athlete performing a core workout" /><div className="photo-tag">No shortcuts.<br /><strong>Just work.</strong></div></div><div className="about-copy"><p className="eyebrow"><span /> More than a gym</p><h2>It&apos;s your<br /><em>grind.</em></h2><p className="body-copy">Our services include Personal Training, Fitness Training, Body Building, Weight Fitting, Weight Gain, Weight Loss, Nutrition Solution and Cardio.</p><a href="#facilities" className="text-link">Discover our approach <ArrowUpRight size={16} /></a><div className="stats"><div><strong>500<span>+</span></strong><small>Members</small></div><div><strong>20<span>+</span></strong><small>Premium equipment</small></div><div><strong>07/10/2025</strong><small>Opened</small></div><div><strong>100<span>%</span></strong><small>Focus on results</small></div></div></div></div>
      </section>
      ...
      <section id="trainers" className="section container trainers-section"><div className="section-heading"><div><div className="section-kicker">04 <span>Your team</span></div><h2>Built by coaches.<br /><em>Backed by science.</em></h2></div><p>Meet the people in your corner. Every coach brings experience, energy and a genuine investment in your progress.</p></div><div className="trainer-grid"><article className="trainer-card"><img src="/warrior-lower-body.png" alt="Rahul Sharma, strength coach" /><div><span>Strength & conditioning</span><h3>Rahul Sharma</h3><p>8+ years experience</p></div></article><article className="trainer-card"><img src="/warrior-core.png" alt="Maya Iyer, performance coach" /><div><span>Performance coach</span><h3>Maya Iyer</h3><p>6+ years experience</p></div></article><article className="trainer-card"><img src="/warrior-upper-body.png" alt="Dev Malhotra, personal trainer" /><div><span>Personal training</span><h3>Dev Malhotra</h3><p>10+ years experience</p></div></article></div></section>
